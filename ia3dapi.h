...
// A3dApi Class ID {92FA2C24-253C-11d2-90FB-006008A1F441}
...
// Init flags
#define A3D_MIDI						0x00000001
#define A3D_1ST_REFLECTIONS				0x00000002
#define A3D_LATE_REFLECTIONS			0x00000004
#define A3D_DIRECT_PATH_A3D				0x00000008
#define A3D_DIRECT_PATH_GENERIC         0X00000020 //VALUE CORRECT?
#define A3D_AUTO_DOPPLER				0x00000010
#define A3D_DISTANCE_MODEL				0x00000020
...
#define A3DRENDERPREFS_A3D             0x0
#define A3DRENDERPREFS_FORCE_EMULATION 0x1
#define A3DRENDERPREFS_ALLOW_DS3D      0x2
#define A3DRENDERPREFS_DEFAULT         A3DRENDERPREFS_A3D

#define A3DSOURCE_TRANSFORMMODE_NORMAL       0x0000
#define A3DSOURCE_TRANSFORMMODE_HEADRELATIVE 0x0001
...
// Definitions needed from old ia3d.h
...
#define IA3dMaterial_GetTransmittance(p,a,b)	(p)->lpVtbl->IA3dMaterial_GetTransmittance(p,a,b)
#else // !defined(__cplusplus) || defined(CINTERFACE)
...
#define IA3dMaterial_GetTransmittance(p,a,b)	(p)->IA3dMaterial_GetTransmittance(a,b)
#endif // !defined(__cplusplus) || defined(CINTERFACE)
...
// {C398E566-D90B-11d1-90FB-006008A1F441}
DEFINE_GUID(IID_IA3dEnvironment, 0xc398e566, 0xd90b, 0x11d1, 0x90, 0xfb, 0x0, 0x60, 0x8, 0xa1, 0xf4, 0x41);

#undef INTERFACE
#define INTERFACE IA3dEnvironment

DECLARE_INTERFACE_(IA3dEnvironment, IUnknown)
{
	// IUnknown Methods.
	STDMETHOD(QueryInterface)		(THIS_ REFIID, LPVOID FAR *) PURE;
	STDMETHOD_(ULONG,AddRef)		(THIS) PURE;
	...
	// IA3dEnvironment Methods.
	STDMETHOD(SetPreset)			(THIS_ INT) PURE;
	STDMETHOD(GetPreset)			(THIS_ LPINT) PURE;
	STDMETHOD(SetSpeedOfSound)		(THIS_ A3DVAL) PURE;
	STDMETHOD(GetSpeedOfSound)		(THIS_ LPA3DVAL) PURE;
	STDMETHOD(SetAbsorption4f)		(THIS_ A3DVAL, A3DVAL, A3DVAL, A3DVAL) PURE;    
	STDMETHOD(GetAbsorption4f)		(THIS_ LPA3DVAL, LPA3DVAL, LPA3DVAL, LPA3DVAL) PURE;    
	STDMETHOD(SetAbsorption4fv)		(THIS_ LPA3DVAL) PURE;    
	STDMETHOD(GetAbsorption4fv)		(THIS_ LPA3DVAL) PURE;    
	STDMETHOD(SetAttenuationRate)	(THIS_ A3DVAL) PURE;    
	STDMETHOD(GetAttenuationRate)	(THIS_ LPA3DVAL) PURE;    
	STDMETHOD(SetReverbGain)		(THIS_ A3DVAL) PURE;    
	STDMETHOD(GetReverbGain)		(THIS_ LPA3DVAL) PURE;    
	STDMETHOD(SetPreDelay)			(THIS_ A3DVAL) PURE;    
	STDMETHOD(GetPreDelay)			(THIS_ LPA3DVAL) PURE;    
	STDMETHOD(SetReverbDecay)		(THIS_ A3DVAL) PURE;    
	STDMETHOD(GetReverbDecay)		(THIS_ LPA3DVAL) PURE;    
	STDMETHOD(SetReverbBrightness)	(THIS_ A3DVAL) PURE;    
	STDMETHOD(GetReverbBrightness)	(THIS_ LPA3DVAL) PURE;    
	STDMETHOD(SetReverbSourceGain)	(THIS_ LPA3DSOURCE, A3DVAL) PURE;    
	STDMETHOD(GetReverbSourceGain)	(THIS_ LPA3DSOURCE, LPA3DVAL) PURE;    
	STDMETHOD(Load)					(THIS_ LPSTR) PURE;
	STDMETHOD(Save)					(THIS_ LPSTR) PURE;
	STDMETHOD(Serialize)			(THIS_ LPVOID *, UINT *) PURE;
	STDMETHOD(UnSerialize)			(THIS_ LPVOID, UINT) PURE;
	STDMETHOD(Duplicate)			(THIS_ LPA3DENVIRONMENT *) PURE;
	STDMETHOD(SetNameID)			(THIS_ LPSTR) PURE;
	STDMETHOD(GetNameID)			(THIS_ LPSTR, INT) PURE;
};

#if !defined(__cplusplus) || defined(CINTERFACE)
#define IA3dEnvironment_QueryInterface(p,a,b)		(p)->lpVtbl->QueryInterface(p,a,b)
#define IA3dEnvironment_AddRef(p)					(p)->lpVtbl->AddRef(p)
#define IA3dEnvironment_Release(p)					(p)->lpVtbl->Release(p)
#define IA3dEnvironment_SetPreset(p,a)				(p)->lpVtbl->SetPreset(p,a)
#define IA3dEnvironment_GetPreset(p,a)				(p)->lpVtbl->GetPreset(p,a)
#define IA3dEnvironment_SetSpeedOfSound(p,a)		(p)->lpVtbl->SetSpeedOfSound(p,a)
#define IA3dEnvironment_GetSpeedOfSound(p,a)		(p)->lpVtbl->GetSpeedOfSound(p,a)
#define IA3dEnvironment_SetAbsorption4f(p,a,b,c,d)	(p)->lpVtbl->SetAbsorption4f(p,a,b,c,d)
#define IA3dEnvironment_GetAbsorption4f(p,a,b,c,d)	(p)->lpVtbl->GetAbsorption4f(p,a,b,c,d)
#define IA3dEnvironment_SetAbsorption4fv(p,a)		(p)->lpVtbl->SetAbsorption4fv(p,a)
#define IA3dEnvironment_GetAbsorption4fv(p,a)		(p)->lpVtbl->GetAbsorption4fv(p,a)
#define IA3dEnvironment_SetAttenuationRate(p,a)		(p)->lpVtbl->SetAttenuationRate(p,a)
#define IA3dEnvironment_GetAttenuationRate(p,a)		(p)->lpVtbl->GetAttenuationRate(p,a)
#define IA3dEnvironment_SetReverbGain(p,a)			(p)->lpVtbl->SetReverbGain(p,a)
#define IA3dEnvironment_GetReverbGain(p,a)			(p)->lpVtbl->GetReverbGain(p,a)
#define IA3dEnvironment_SetPreDelay(p,a)			(p)->lpVtbl->SetPreDelay(p,a)
#define IA3dEnvironment_GetPreDelay(p,a)			(p)->lpVtbl->GetPreDelay(p,a)
#define IA3dEnvironment_SetReverbDecay(p,a)			(p)->lpVtbl->SetReverbDecay(p,a)
#define IA3dEnvironment_GetReverbDecay(p,a)			(p)->lpVtbl->GetReverbDecay(p,a)
#define IA3dEnvironment_SetReverbBrightness(p,a)	(p)->lpVtbl->SetReverbBrightness(p,a)
#define IA3dEnvironment_GetReverbBrightness(p,a)	(p)->lpVtbl->GetReverbBrightness(p,a)
#define IA3dEnvironment_SetReverbSourceGain(p,a,b)	(p)->lpVtbl->SetReverbSourceGain(p,a,b)
#define IA3dEnvironment_GetReverbSourceGain(p,a,b)	(p)->lpVtbl->GetReverbSourceGain(p,a,b)
#define IA3dEnvironment_Load(p,a)					(p)->lpVtbl->Load(p,a)
#define IA3dEnvironment_Save(p,a)					(p)->lpVtbl->Save(p,a)
#define IA3dEnvironment_Serialize(p,a,b)			(p)->lpVtbl->Serialize(p,a,b)
#define IA3dEnvironment_UnSerialize(p,a,b)			(p)->lpVtbl->UnSerialize(p,a,b)
#define IA3dEnvironment_Duplicate(p,a)				(p)->lpVtbl->Duplicate(p,a)
#define IA3dEnvironment_SetNameID(p,a)				(p)->lpVtbl->SetNameID(p,a)
#define IA3dEnvironment_GetNameID(p,a,b)			(p)->lpVtbl->GetNameID(p,a,b)
#else // !defined(__cplusplus) || defined(CINTERFACE)
#define IA3dEnvironment_QueryInterface(p,a,b)		(p)->QueryInterface(a,b)
#define IA3dEnvironment_AddRef(p)					(p)->AddRef()
#define IA3dEnvironment_Release(p)					(p)->Release()
#define IA3dEnvironment_SetPreset(p,a)				(p)->SetPreset(a)
#define IA3dEnvironment_GetPreset(p,a)				(p)->GetPreset(a)
#define IA3dEnvironment_SetSpeedOfSound(p,a)		(p)->SetSpeedOfSound(a)
#define IA3dEnvironment_GetSpeedOfSound(p,a)		(p)->GetSpeedOfSound(a)
#define IA3dEnvironment_SetAbsorption4f(p,a,b,c,d)	(p)->SetAbsorption4f(a,b,c,d)
#define IA3dEnvironment_GetAbsorption4f(p,a,b,c,d)	(p)->GetAbsorption4f(a,b,c,d)
#define IA3dEnvironment_SetAbsorption4fv(p,a)		(p)->SetAbsorption4fv(a)
#define IA3dEnvironment_GetAbsorption4fv(p,a)		(p)->GetAbsorption4fv(a)
#define IA3dEnvironment_SetAttenuationRate(p,a)		(p)->SetAttenuationRate(a)
#define IA3dEnvironment_GetAttenuationRate(p,a)		(p)->GetAttenuationRate(a)
#define IA3dEnvironment_SetReverbGain(p,a)			(p)->SetReverbGain(a)
#define IA3dEnvironment_GetReverbGain(p,a)			(p)->GetReverbGain(a)
#define IA3dEnvironment_SetPreDelay(p,a)			(p)->SetPreDelay(a)
#define IA3dEnvironment_GetPreDelay(p,a)			(p)->GetPreDelay(a)
#define IA3dEnvironment_SetReverbDecay(p,a)			(p)->SetReverbDecay(a)
#define IA3dEnvironment_GetReverbDecay(p,a)			(p)->GetReverbDecay(a)
#define IA3dEnvironment_SetReverbBrightness(p,a)	(p)->SetReverbBrightness(a)
#define IA3dEnvironment_GetReverbBrightness(p,a)	(p)->GetReverbBrightness(a)
#define IA3dEnvironment_SetReverbSourceGain(p,a,b)	(p)->SetReverbSourceGain(a,b)
#define IA3dEnvironment_GetReverbSourceGain(p,a,b)	(p)->GetReverbSourceGain(a,b)
#define IA3dEnvironment_Load(p,a)					(p)->Load(a)
#define IA3dEnvironment_Save(p,a)					(p)->Save(a)
#define IA3dEnvironment_Serialize(p,a,b)			(p)->Serialize(a,b)
#define IA3dEnvironment_UnSerialize(p,a,b)			(p)->UnSerialize(a,b)
#define IA3dEnvironment_Duplicate(p,a)				(p)->Duplicate(a)
#define IA3dEnvironment_SetNameID(p,a)				(p)->SetNameID(a)
#define IA3dEnvironment_GetNameID(p,a,b)			(p)->GetNameID(a,b)
#endif // !defined(__cplusplus) || defined(CINTERFACE)
...
// IA3d.h is obsolte, just add it here for programming convienence.
// All updates to IA3dApi.h
